...
public class demo02 {
    public static void main(String[] args) throws Exception {
        ...
        env
                ...
                .process(new MyResUlt())
                .print();
        env.execute();
    }
    public static class MyResUlt extends ProcessWindowFunction<Event, userViewCountPerWindow,String, TimeWindow>{
        @Override
        public void process(String s, ProcessWindowFunction<Event, userViewCountPerWindow, String, TimeWindow>.Context context, Iterable<Event> iterable, Collector<userViewCountPerWindow> collector) throws Exception {
            collector.collect(new userViewCountPerWindow(s,
